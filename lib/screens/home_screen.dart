              ...
              Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Tic',
                      style: GoogleFonts.lora(fontSize: 60, fontWeight: FontWeight.w700, color: Colors.redAccent),
                    ),
                    Text(
                      'Tac',
                      style: GoogleFonts.lora(fontSize: 60, fontWeight: FontWeight.w700, color: Colors.pinkAccent),
                    ),
                    Text(
                      'Toe',
